...
export default function FooterScene() {
  return (
    <footer className="relative z-20 bg-slate-950/95 backdrop-blur-xl text-slate-400 pointer-events-auto">
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs">&copy; {new Date().getFullYear()} ScamShield. Built for safer digital payments in India.</p>
